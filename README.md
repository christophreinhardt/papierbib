...
Die neue mobile Erfassung läuft als **selbst gehostete PWA (0.3.1, Phase 2)**
...
1. ZIP `dist/Papierbibliothek-0.6.11.zip` in Calibre als Erweiterung laden und Calibre neu starten.
...
1. Calibre öffnen. Unter **Einstellungen → Erweiterungen → Erweiterung aus Datei laden** die Datei `dist/Papierbibliothek-0.6.11.zip` auswählen. Je nach Übersetzung heißt der Bereich „Plugins“.
